...
# rule for vi
# use "make [option] TRACE=true" to enable trace
ifdef TRACE
...
fs.img: $T/mkfs README $(UPROGS) $(TMP_VI_SYNTAX) $(TMP_VI_TEST)
    $T/mkfs fs.img README $(UPROGS) $(TMP_VI_SYNTAX) $(TMP_VI_TEST)
	rm $(TMP_VI_SYNTAX) $(TMP_VI_TEST)
